...
interface Product {
  ...
  const ProductCard = ({ product }: { product: Product }) => {
    ...
    return (
      <div className="group relative bg-white shadow-lg rounded-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
        ...
        <div className="p-4">
          ...
          <Link 
            ...
            className="block mt-4 text-center text-blue-500 hover:text-blue-700 transition-colors"
          >
            Lihat Detail Produk
          </Link>
        </div>
